...
class ModuleReservationConditionDelete extends ExecModule {
  ...
  protected function _userRun() {
    ...
    $bReservationCondition->delete();

    $this->_app->messages->addMessage('userInfo', sprintf($this->_app->textStorage->getText('info.listReservationCondition_deleteOk'), $data['name']));
