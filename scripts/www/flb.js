function flbInit(urlPath,provider,elements) {
  var initElements = elements instanceof Array;
  
  var div = $('<div id="flb_core" />').appendTo('body');
  $.ajax({
...
function flbLoginRequired(language) {
  ...
  params['externalAccount'] = 1;
  params['externalAccountFirst'] = 1;
...
function flbPaymentGateway(url,gateway,target,targetId,targetParams,placeHolder,jsBackAction) {
  var w = 900;
  var h = 650;
