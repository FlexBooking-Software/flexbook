...
class SReservationAttribute extends MySqlSelect {
  private $_tReservationAttribute;
  private $_tAttribute;
  private $_tAttributeName;
  private $_tCustomer;
  
  private function _insertReservationAttributeTable() {
    $this->_tReservationAttribute = new SqlTable('reservation_attribute', 'ra');
    
    $this->addColumn(new SqlColumn($this->_tReservationAttribute, 'reservation'));
    $this->addColumn(new SqlColumn($this->_tReservationAttribute, 'attribute'));
    $this->addColumn(new SqlColumn($this->_tReservationAttribute, 'value'));
  }
  ...
  protected function _initSqlSelect() {
    $this->_insertReservationAttributeTable();
