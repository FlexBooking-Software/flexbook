...
class SAvailabilityExceptionProfile extends SqlSelect {
  private $_tAvailabilityExceptionProfile;
  private $_tCustomer;
  private $_tProvider;
  
  private function _insertAvailabilityExceptionProfileTable() {
    $this->_tAvailabilityExceptionProfile = new SqlTable('availabilityexceptionprofile', 'ap');

    $this->addColumn(new SqlColumn($this->_tAvailabilityExceptionProfile, 'availabilityexceptionprofile_id'));
    $this->addColumn(new SqlColumn($this->_tAvailabilityExceptionProfile, 'name'));
    $this->addColumn(new SqlColumn($this->_tAvailabilityExceptionProfile, 'provider'));
  }
