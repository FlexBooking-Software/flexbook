...
class SEventAttribute extends MySqlSelect {
  private $_tEventAttribute;
  private $_tAttribute;
  private $_tAttributeName;
  private $_tCustomer;
  
  private function _insertEventAttributeTable() {
    $this->_tEventAttribute = new SqlTable('event_attribute', 'ea');
    
    $this->addColumn(new SqlColumn($this->_tEventAttribute, 'event'));
    $this->addColumn(new SqlColumn($this->_tEventAttribute, 'attribute'));
    $this->addColumn(new SqlColumn($this->_tEventAttribute, 'value'));
  }
  ...
  protected function _initSqlSelect() {
    $this->_insertEventAttributeTable();
